...
| [Connection String](./connection-string/) | Configure file paths, connection modes, encryption, upgrades, collations, and memory limits. |
...
| [Versioning](./versioning/versioning.md) | See how LiteDB evolves, how semantic versioning applies, and where to find upgrade notes. |
