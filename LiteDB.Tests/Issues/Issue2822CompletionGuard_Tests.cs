...
namespace LiteDB.Tests.Issues
{
    public class Issue2822CompletionGuard_Tests
    {
        ...
        public void Foreign_completion_rejects_without_committing_or_rolling_back_owner(bool commit, ConnectionType connection)
        {
            ...
            failure.Should().BeOfType<LiteException>().Which.Message.Should().Contain("same thread").And.Contain("await");
