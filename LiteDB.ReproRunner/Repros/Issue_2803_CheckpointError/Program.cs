...
internal static class Program
{
    private static int Main()
    {
        ...
        for (var attempt = 1; attempt <= attempts; attempt++)
        {
            try
            {
                new Issue2803_CheckpointFailureTests().EnsureIndex_preserves_a_post_commit_checkpoint_error_and_the_committed_index();
        ...
        Console.WriteLine($"REPEATS_2803: attempts={attempts}, reportedFailures={failures}");
        Console.WriteLine(failures > 0 ? "BUG_2803_CONFIRMED" : "VERIFIED_2803");
